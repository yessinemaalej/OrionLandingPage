...
export const Hero = () => {
  return (
    <div id="hero" className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_40%,#4F21A1_59%,#000_82%)] py-[72px] sm:py-24 relative overflow-clip">
        ...
        <div className="flex justify-center">
            <h1 className="text-4xl sm:text-7xl font-bold tracking-tighter text-center mt-8 inline-flex">Shape the Future of Energy Exchange</h1>
        </div>
